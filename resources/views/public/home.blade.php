...
<nav class="max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
    <div class="flex items-center gap-3">
        <div class="w-11 h-11 rounded-2xl btn-primary flex items-center justify-center font-black shadow-lg">
            A
        </div>
        <div>
...
<section class="min-h-[82vh] flex items-center relative overflow-hidden">
    <div class="absolute left-10 top-20 w-72 h-72 rounded-full blur-3xl opacity-20" style="background: var(--primary)"></div>
    <div class="absolute right-10 bottom-20 w-96 h-96 rounded-full blur-3xl opacity-20" style="background: var(--secondary)"></div>
    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div>
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-3">
                ...
                <a href="#paket"
                    class="glass px-7 py-4 rounded-2xl font-bold text-center">
                    Lihat Paket
                </a>
            </div>
        ...
        <div class="glass rounded-[2rem] p-5 shadow-2xl">
            <div class="card-theme rounded-[1.5rem] p-5">
                ...
                <div class="rounded-3xl p-5 mb-4" style="background: linear-gradient(135deg, var(--primary), var(--secondary));">
...
<section id="fitur" class="py-16">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
            @foreach ([
                ['🎨','Atur Tampilan','Logo, warna, nama toko, dan konten sederhana.'],
                ['📦','Kelola Produk','Tambah produk dan arahkan ke marketplace.'],
                ['🔗','Link Sendiri','Dapat username.affilio.store setelah aktif.'],
                ['💬','Chat Admin','Bantuan manual, nanti bisa dikembangkan AI.'],
            ] as $fitur)
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @foreach ($packages as $package)
                <div class="glass rounded-[2rem] p-6 relative overflow-hidden">
                    <div class="absolute right-0 top-0 w-40 h-40 blur-3xl opacity-20" style="background: var(--primary)"></div>

                    @if ($package->package_badge)
                        <div class="inline-flex px-3 py-1 rounded-full text-xs mb-4" style="background: color-mix(in srgb, var(--primary) 20%, transparent); color: var(--text);">
